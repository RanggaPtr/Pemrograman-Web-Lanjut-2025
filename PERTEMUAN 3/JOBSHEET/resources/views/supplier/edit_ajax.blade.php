        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_kode" id="supplier_kode" class="form-control" value="{{ $supplier->supplier_kode }}" readonly>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_alamat" id="supplier_alamat" class="form-control" value="{{ $supplier->supplier_alamat }}" required>
...
$(document).ready(function() {
    $("#form-edit").validate({
        rules: {
            ...
            supplier_nama: { required: true, minlength: 10, maxlength: 30 },
            supplier_alamat: { required: true, minlength: 10, maxlength: 100 },
