...
Route::group(['prefix'=>'user'],function(){
    ...
    Route::get('{id}/delete_ajax', [UserController::class, 'delete_ajax']);
    Route::delete('{id}/delete_ajax', [UserController::class, 'destroy_ajax']);
});

Route::group(['prefix'=>'level'],function(){
    Route::get('/',[LevelController::class,'index']);            //menampilkan halaman awal pada user
